...
public class IdCardValidator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String idCard15 = "510121199411120655";
        String idCard18 = "510121199411120655";
...
//        flag = iv.isValidate18IdCard(iv.convertIdcarBy15bit(idCard15));
   ...
   public static class IdCardInfoExtractor {
        ...
        public String toString() {
            return "省份：" + this.province + ",性别：" + this.gender + ",年龄：" + this.age + ",出生日期："
                    + this.birthday;
        }

        public static void main(String[] args) {
            String idCard = "510121199411120655";
